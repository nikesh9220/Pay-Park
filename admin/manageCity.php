                                    ...
                                    while ($data=mysqli_fetch_array($q)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="center" style="width: 150px">
                                                ...
                                                <form style="float: left; margin-right: 3px;" action="citycontroller.php" method="post">
                                                    <input type="hidden" name="cat_id" value="<?php echo $data['cityid']; ?>">
