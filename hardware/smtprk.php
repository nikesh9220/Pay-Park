  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="smtprk.php">Home</a></li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="DisplayStatus.php">Led Control</a></li>
            <li><a href="ParkingLotDisplay.php">Smart Parking Lot</a></li>
          </ul>
        </li>
        <li><a href="hardware/aboutme.html">About Me</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
